...
class Track:
    ...
    def __init__(self, id, in_point = None, out_point = None, state = TRACK_NORMAL, normal_color = None, safe_color = None, danger_color = None):
        self.id = id
...
class Signal:
    ...
    def __init__(self, id, position, state = SIGNAL_DANGER, clear_color = None, danger_color = None):
        self.id = id
...
class Turnout:
    ...
    def __init__(self, id, position, entry = None, normal = None, reverse = None, normal_color = None, safe_color = None, danger_color = None, point_color = None):
        self.id = id
        self.position = position
        if normal_color is None:
...
class Block:
    ...
    def __init__(self, id, label = None, label_position = None, label_font_size = 20, label_color = None):
        self.id = id
        self.label = label
